  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'お名前（姓）が全角以外では登録できない' do
        @user.last_name = 'a1-'
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name全角文字で入力してください")
      end
      ...
      it 'お名前（名）が全角以外では登録できない' do
        @user.first_name = 'a1-'
        @user.valid?
        expect(@user.errors.full_messages).to include("First name全角文字で入力してください")
      end
      ...
      it 'お名前カナ（姓）が全角以外では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name kana全角カナ文字で入力してください")
      end
      ...
      it 'お名前（名）が全角以外では登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("First name kana全角カナ文字で入力してください")
      end
